...
public class AddGame extends AdminCommand {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) {
        ...
        game.getGenre().setId(Integer.parseInt( request.getParameter("genre")));
        game.setExclusivity(Integer.parseInt( request.getParameter("exclusivity")));
        game.setReleaseDate(Timestamp.valueOf(request.getParameter("date")+" 00:00:00.0"));
