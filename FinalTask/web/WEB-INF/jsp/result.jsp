            ...
            <div class="carousel-item active">
                ...
                <div class="container " width="100%" height="100%" style="font-family: Arial; ">
                    <div class="carousel-caption text-center "
                        ...
                        <p><fmt:message key="carousel_start"/></p>
                        <form action="/game_offers.html" method="post">
                            <button class="btn btn-lg btn-primary " type="submit"><fmt:message key="to_offers"/></button>
                        </form>
                    </div>
                </div>
            </div>
                 ...
                 font-family: Arial; font-size:150%; ">
                    <div class="row" style="position: absolute; top: 0; bottom: 0 ; left: 0; ">
                        ...
                        <div class="col-sm-5" style="background-color:lavender; padding: unset; text-align: center">
                            ...
                            <p><fmt:message key="genre"/>: ${offer.game.genre.name}</p>

                            <c:choose>
                                <c:when test="${offer.game.exclusivity==0}">
                                    <p><fmt:message key="exclusivity"/>: PS4 </p>
                                </c:when>
                                <c:when test="${offer.game.exclusivity==1}">
                                    <p><fmt:message key="exclusivity"/>: XBOX ONE X </p>
                                </c:when>
                                <c:otherwise>
                                </c:otherwise>
                            </c:choose>
                            ...
                            <form action="/game_offer.html" method="post">
                                ...
                                <button class="btn btn-lg btn-primary" type="submit"><fmt:message key="to_offer"/></button>
                            </form>
