...
public final class FillLock implements Command {

    private final Logger logger = LogManager.getLogger(FillLock.class);
    ...
    public String execute(final String request) {
        ...
        try {
            ...
            response = "There are some problems with filling with only locker";
        }
